...
# Use os.getenv to allow override, falling back to settings
db_url = os.getenv("DATABASE_URL", str(settings.DATABASE_URL))
if not db_url:
    raise ValueError("DATABASE_URL environment variable or setting must be set")
...
async def run_migrations_online() -> None:
    ...
    connectable = async_engine_from_config(
        ...
        prefix="sqlalchemy.",
        poolclass=pool.NullPool, # Use NullPool for async migrations
    )
