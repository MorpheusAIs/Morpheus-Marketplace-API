#!/usr/bin/env python3
"""
Test API key verification timing with the STG environment.
...
# Configuration
API_KEY = "sk-50XOQ2.792a666b46e82ce8c09d7a8f1e58988f870594c105138f89b559fc20332e3bb3"
API_URL = "https://api.stg.mor.org/api/v1/models"
NUM_ITERATIONS = 20
...
def main():
    ...
    print("\n" + "="*60)
    print("API Key Authentication Timing Test")
    print("="*60)
    ...
    for cycle in range(1, 4):  # 3 cycles
        stats = run_timing_test(f"Cycle {cycle}: API Key Verification", NUM_ITERATIONS)
        if stats:
